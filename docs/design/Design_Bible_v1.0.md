...
- **Origin Story:** Editorial, long-form layout. Focus on _why_ NorAI was founded.
...
- **Primary Font:** _Inter_ (UI, headings, body).
- **Monospace Font:** _JetBrains Mono_ (Code snippets).
...
- **Rule:** Scroll animations trigger _once_. Elements fade and translate upward slightly.
